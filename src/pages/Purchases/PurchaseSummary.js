...
const handlePrintResumo = (productTotals) => {
...
export const PurchaseSummary = ({ productTotals }) => {
    return (
        <Container className="mt-4 pt-4 border-top">
            <div className="d-flex justify-content-between align-items-center mb-3">
                <h4>Resumo de Pedidos</h4>
                <Button variant="outline-secondary" onClick={() => handlePrintResumo(productTotals)} disabled={productTotals.length === 0}>
                    Imprimir
                </Button>
            </div>
